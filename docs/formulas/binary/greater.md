# Formule de test de supériorité stricte (GREATER)
...
__ATTENTION__ :
Le test de supériorité stricte ne peux se faire qu'entre certains type de données. Ce référer aux "usages" et à la syntaxe pour savoir ce quels types sont compatibles à la comparaison.
...
4. Différence entre paramètres de type [`durée`][valeur-de-retour]
