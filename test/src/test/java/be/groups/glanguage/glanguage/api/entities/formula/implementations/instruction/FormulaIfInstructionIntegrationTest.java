 ...
 * @author DUPIREFR
 */
public class FormulaIfInstructionIntegrationTest {
	...
	public void testGetIntegerValueCondTrue() throws GLanguageException {
		...
		FormulaIfInstruction formula = spy(FormulaIfInstruction.class);
	...
	public void testGetIntegerValueCondFalseCondTrue() throws GLanguageException {
		...
		FormulaIfInstruction subFormula = spy(FormulaIfInstruction.class);
