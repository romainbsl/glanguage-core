...
public class FormulaAndTest {
	...
	/**
	 * Tests {@link FormulaAnd#getBooleanValue()} when parameters exist and left
	 * is false
	 */
	@Test
	...
	/**
	 * Tests {@link FormulaAnd#getBooleanValue()} when parameters exist and
	 * right is false
	 */
	@Test
	...
	/**
	 * Tests {@link FormulaAnd#getBooleanValue()} when left true and right
	 * doesn't exist
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Tests {@link FormulaAnd#getBooleanValue()} when left false and right
	 * doesn't exist
	 */
	@Test
	...
	/**
	 * Tests {@link FormulaAnd#getBooleanValue()} when both parameter don't
	 * exist
	 */
	@Test(expected = NullPointerException.class)
