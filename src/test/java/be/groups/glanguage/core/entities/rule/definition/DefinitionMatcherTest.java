...
public class DefinitionMatcherTest {
	...
	/**
	 * Tests
	 * {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)}
	...
	public void testMatchAtLeastOneByLevelBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_LEAST_ONE_BY_LEVEL));
	}
	
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when first
	...
	public void testMatchAtLeastOneByLevelFirstNullSecondNot() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_LEAST_ONE_BY_LEVEL));
	}
	
	/**
	 * Tests
	 * {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when second
	...
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when both
	...
	public void testMatchAtLeastBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_LEAST));
	}
	...
	public void testMatchAtLeastFirstNullSecondNot() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_LEAST));
	}
	...
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when both collections are
	...
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when first collection is
	...
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when second collection is
	...
	/**
	 * Tests {@link DefinitionMatcher#matches(Collection, Collection, DefinitionMatcher.DefinitionMatcherStrategy)} when both collections
	...
	public void testMatchAtMostOneByLevelBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_MOST_ONE_BY_LEVEL));
	}
	...
	public void testMatchAtMostOneByLevelSecondNullFirstNot() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_MOST_ONE_BY_LEVEL));
	}
	...
	public void testMatchAtMostBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_MOST));
	}
	...
	public void testMatchAtMostSecondNullFirstNot() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.AT_MOST));
	}
...
//		when(jointCommitteeDefinitionParameter.matches(any())).thenReturn(false);
	...
	public void testMatchStrictlyBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.STRICTLY));
	}
	...
	public void testMatchStrictlyFirstNullSecondNot() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.STRICTLY));
	}
	...
	public void testMatchLooselyBothNull() {
		...
		assertTrue(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.LOOSELY));
	}
	...
	public void testMatchLooselyBothOneParameterNotMatching() {
		...
		assertFalse(DefinitionMatcher.matches(definition, criteria, DefinitionMatcher.DefinitionMatcherStrategy.LOOSELY));
	}
