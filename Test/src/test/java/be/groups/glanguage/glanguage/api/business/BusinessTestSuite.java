...
import be.groups.glanguage.glanguage.api.business.evaluation.PlanEvaluatorTest;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({FormulaDescriptionFactoryTest.class, ParserTest.class, PlanEvaluatorTest.class, PlanTest.class,
        UniverseTest.class})
