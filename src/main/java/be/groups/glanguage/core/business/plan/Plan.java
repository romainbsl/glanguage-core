...
//                    .forEach(rv -> evaluate(rv, recursive, evaluator));
     ...
     * {@link RuleIdentity#id}
     *
     * @param ruleId the {@link RuleIdentity#id} of the
     *               {@link RuleVersion} to be returned
     * @return the {@link RuleVersion} with the
     * {@link RuleIdentity#id} corresponding to {@code ruleIdentifier},
     ...
     * {@link RuleDescription#code}
     *
     * @param code the {@link RuleDescription#code} of the
     *             {@link RuleVersion} to be returned
     * @return the {@link RuleVersion} with the
     * {@link RuleDescription#code} corresponding to {@code code},
     * or null if it doesn't exists
     */
