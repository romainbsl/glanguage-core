...
public class FormulaDurationDaysTest {
	...
	public void testGetDiscriminatorValue() {
		...
		Assert.assertEquals(Integer.valueOf(FormulaType.Values.F_DAYS), formula.getDiscriminatorValue());
	}
	...
	public void testGetIntegerValueDateParameter() throws GLanguageException {
		...
		Assert.assertEquals(Integer.valueOf(10), formula.getIntegerValue(null));
	}
	...
	public void testGetDurationValueIntegerParameter() throws GLanguageException {
		...
		Assert.assertEquals(Duration.ofDays(10L), formula.getDurationValue(null));
	}
