 ...
 * @author DUPIREFR
 */
public class FormulaGreaterIntegrationTest extends BaseDatabaseTest {
	...
	public void testIsValidBothIntegers() throws GLanguageException {
		...
		doReturn(FormulaDescriptionFactory.getDescription(FormulaType.OP_GREATER)).when(formula).getDescription();
	...
	/**
	 * Tests {@link FormulaGreater#isValid(Evaluator)} when first operand is integer and second numeric
	 */
	@Test
	@Category({DatabaseTestCategory.class})
	...
	/**
	 * Tests {@link FormulaGreater#isValid(Evaluator)} when first operand is numeric and second integer
	 */
	@Test
	@Category({DatabaseTestCategory.class})
	...
	/**
	 * Tests {@link FormulaGreater#isValid(Evaluator)} when first operand is a date and second is a duration
	 */
	@Test
	@Category({DatabaseTestCategory.class})
	...
	/**
	 * Tests {@link FormulaGreater#isValid(Evaluator)} when first operand is a duration and second is a date
	 */
	@Test
	@Category({DatabaseTestCategory.class})
