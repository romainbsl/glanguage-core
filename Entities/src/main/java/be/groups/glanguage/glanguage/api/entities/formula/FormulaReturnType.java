...
public enum FormulaReturnType {
	 ...
	 * 
	 * @param returnTypeId the id that has to be translated into a ReturnType
	 * @return the ReturnType which ordinal number equals the specified returnTypeId if it exists, null otherwise
	 */
