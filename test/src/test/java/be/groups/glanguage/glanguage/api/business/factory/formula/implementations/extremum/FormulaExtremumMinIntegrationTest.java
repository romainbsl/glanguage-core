...
public class FormulaExtremumMinIntegrationTest extends DaoIntegrationTest {
  ...
  public void testIsValidMatchingIntegers() throws GLanguageException {
    ...
    doReturn(formulaDescriptionFactory.getDescription(FormulaType.F_MIN)).when(formula)
                                                                         .getDescription();
