...
import be.groups.glanguage.core.entities.formula.implementations.binary.FormulaDifference;
...
public class FormulaDifferenceIntegrationTest extends IntegrationTest {
  ...
  public void testIsValidBothIntegers() throws GLanguageException {
    ...
    doReturn(formulaDescriptionFactory.getDescription(FormulaType.OP_DIFFERENCE)).when(formula)
                                                                                 .getDescription();
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when first operand is integer and second
   * numeric
   */
  @Test
  @Category({DatabaseTestCategory.class})
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when first operand is integer and second is
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when second operand is integer and first is
   * not integer or numeric
   */
  @Test
  @Category({DatabaseTestCategory.class})
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when first operand is numeric and second
   * integer
   */
  @Test
  @Category({DatabaseTestCategory.class})
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when first operand is numeric and second is
   * not integer or numeric
   */
  @Test
  @Category({DatabaseTestCategory.class})
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when second operand is numeric and first is
   * not integer or numeric
   */
  @Test
  @Category({DatabaseTestCategory.class})
  ...
  /**
   * Tests {@link FormulaDifference#isValid(Evaluator)} when first operand is a duration and second
   * is a date
   */
  @Test
  @Category({DatabaseTestCategory.class})
