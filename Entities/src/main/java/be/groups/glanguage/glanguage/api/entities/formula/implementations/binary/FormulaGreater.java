...
/**
 * Formula representing a logical greater operation<br>
 * This Formula has exactly two (2) parameters
 * 
 * @author michotte
 */
@Entity
@DiscriminatorValue(FormulaDescription.Values.OP_GREATER)
public class FormulaGreater extends BinaryFormula {
	...
	public FormulaGreater(AbstractFormula child1, AbstractFormula child2) {
		super(FormulaDescription.OP_GREATER, child1, child2);
	}
