...
import be.groups.glanguage.core.entities.formula.description.combination.FormulaParameterCombinationItemType;
import be.groups.glanguage.core.entities.formula.description.usage.FormulaUsage;
import be.groups.glanguage.core.entities.formula.description.usage.FormulaUsageReturnType;
import be.groups.glanguage.core.error.exception.GLanguageException;
import be.groups.glanguage.core.error.formula.description.FormulaDescriptionNoMatchingUsageInnerError;
import be.groups.glanguage.core.error.formula.description.FormulaDescriptionUnableToValidateInnerError;
...
public class FormulaDescriptionTest {
    ...
    public void testValidateNoBestUsage() throws GLanguageException {
        FormulaDescription description = Mockito.spy(FormulaDescription.class);
