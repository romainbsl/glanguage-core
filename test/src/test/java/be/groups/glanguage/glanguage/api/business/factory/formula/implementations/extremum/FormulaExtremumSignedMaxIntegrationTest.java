...
public class FormulaExtremumSignedMaxIntegrationTest extends DaoIntegrationTest {
  ...
  public void testIsValidMatchingIntegers() throws GLanguageException {
    ...
    doReturn(formulaDescriptionFactory.getDescription(FormulaType.F_SMAX)).when(formula)
                                                                          .getDescription();
