...
public class RuleDefinitionTest {
	...
	public void testGetLevelNoParameters() {
		...
		Assert.assertEquals(DefinitionLevel.DEFAULT, ruleDefinition.getLevel());
	}
	...
	public void testGetLevelOneParameter() {
		...
		assertNotNull(ruleDefinition.getLevel());
		Assert.assertEquals(DefinitionLevel.JOINT_COMMITTEE, ruleDefinition.getLevel());
	}
	...
	public void testGetLevelMultipleDifferentLevelsParameters() {
		...
		assertNotNull(ruleDefinition.getLevel());
		Assert.assertEquals(DefinitionLevel.CUSTOM, ruleDefinition.getLevel());
	}
