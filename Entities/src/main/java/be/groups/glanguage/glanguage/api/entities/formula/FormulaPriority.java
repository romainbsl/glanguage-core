...
public enum FormulaPriority {
	 ...
	 * 
	 * @param formulaPriorityId the id that has to be translated into a FormulaPriority
	 * @return the FormulaPriority which ordinal number equals the specified formulaPriorityId if it exists, null otherwise
	 */
