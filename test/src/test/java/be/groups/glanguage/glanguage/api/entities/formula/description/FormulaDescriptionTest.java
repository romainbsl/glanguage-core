...
public class FormulaDescriptionTest extends BaseDatabaseTest {
    ...
    public void testGetValidUsageOnlyOneValidParameterUsageWithMoreRestrictiveTypes() {
        ...
        FormulaUsage usage1 = mock(FormulaUsage.class);
        when(usage1.isValid(null, null)).thenReturn(true);
        FormulaParameterConbination parameterConbination1 = mock(FormulaParameterConbination.class);
        FormulaParameterConbinationItem parameterConbinationItem1 = mock(FormulaParameterConbinationItem.class);
        Set<FormulaParameterConbinationItemType> parameterConbinationItem1Types = new HashSet<>();
        parameterConbinationItem1Types.add(mock(FormulaParameterConbinationItemType.class));
        when(parameterConbinationItem1.getTypes()).thenReturn(parameterConbinationItem1Types);
        when(usage1.getParameterConbination()).thenReturn(parameterConbination1);
        usages.add(usage1);
        FormulaUsage usage2 = mock(FormulaUsage.class);
        when(usage2.isValid(null, null)).thenReturn(true);
        FormulaParameterConbination parameterConbination2 = mock(FormulaParameterConbination.class);
        FormulaParameterConbinationItem parameterConbinationItem2 = mock(FormulaParameterConbinationItem.class);
        Set<FormulaParameterConbinationItemType> parameterConbinationItem2Types = new HashSet<>();
        parameterConbinationItem2Types.add(mock(FormulaParameterConbinationItemType.class));
        parameterConbinationItem2Types.add(mock(FormulaParameterConbinationItemType.class));
        when(parameterConbinationItem2.getTypes()).thenReturn(parameterConbinationItem2Types);
        when(usage2.getParameterConbination()).thenReturn(parameterConbination2);
        usages.add(usage2);
        when(description.getUsages()).thenReturn(usages);
        List<FormulaUsage> minimalParameterNumberUsages = new ArrayList<>();
        minimalParameterNumberUsages.add(usage1);
    ...
    public void testGetBestMatchingUsageOnlyOneMatchingParameterNumber() {
        ...
        FormulaUsage usage1 = mock(FormulaUsage.class);
        FormulaParameterConbination parameterConbination1 = mock(FormulaParameterConbination.class);
        when(parameterConbination1.getParametersMinimumNumber()).thenReturn(1);
        when(parameterConbination1.getParametersMaximumNumber()).thenReturn(1);
        when(usage1.getParameterConbination()).thenReturn(parameterConbination1);
        usages.add(usage1);
        FormulaUsage usage2 = mock(FormulaUsage.class);
        FormulaParameterConbination parameterConbination2 = mock(FormulaParameterConbination.class);
        when(parameterConbination2.getParametersMinimumNumber()).thenReturn(2);
        when(parameterConbination2.getParametersMaximumNumber()).thenReturn(2);
        when(usage2.getParameterConbination()).thenReturn(parameterConbination2);
        usages.add(usage2);
        when(description.getUsages()).thenReturn(usages);
    ...
    public void testGetBestMatchingUsageOnlyOneMinimalParameterNumber() {
        ...
        FormulaUsage usage2 = mock(FormulaUsage.class);
        FormulaParameterConbination parameterConbination2 = mock(FormulaParameterConbination.class);
        when(parameterConbination2.getParametersMinimumNumber()).thenReturn(1);
        when(parameterConbination2.getParametersMaximumNumber()).thenReturn(2);
        when(usage2.getParameterConbination()).thenReturn(parameterConbination2);
        usages.add(usage2);
        when(description.getUsages()).thenReturn(usages);
    ...
    public void testGetBestMatchingUsageOnlyOneMatchingMinimumParameterNumber() {
        ...
        FormulaUsage usage2 = mock(FormulaUsage.class);
        FormulaParameterConbination parameterConbination2 = mock(FormulaParameterConbination.class);
        when(parameterConbination2.getParametersMinimumNumber()).thenReturn(0);
        when(parameterConbination2.getParametersMaximumNumber()).thenReturn(2);
        when(usage2.getParameterConbination()).thenReturn(parameterConbination2);
        usages.add(usage2);
        when(description.getUsages()).thenReturn(usages);
    ...
    public void testGetBestMatchingUsageOnlyOneMatchingParameterTypesMaximalNumber() {
        ...
        when(parameterConbination1.getParametersMinimumNumber()).thenReturn(1);
        when(parameterConbination1.getParametersMaximumNumber()).thenReturn(1);
        SortedSet<FormulaParameterConbinationItem> parameterConbinationItems1 = new TreeSet<>(Comparator.comparing(
                FormulaParameterConbinationItem::getId));
        FormulaParameterConbinationItem parameterConbinationItem1 = mock(FormulaParameterConbinationItem.class);
        when(parameterConbinationItem1.getId()).thenReturn(1);
        when(parameterConbinationItem1.isValidType(parameters.get(0), null)).thenReturn(true);
        parameterConbinationItems1.add(parameterConbinationItem1);
        when(parameterConbination1.getParameters()).thenReturn(parameterConbinationItems1);
        when(usage1.getParameterConbination()).thenReturn(parameterConbination1);
        usages.add(usage1);
        FormulaUsage usage2 = mock(FormulaUsage.class);
        FormulaParameterConbination parameterConbination2 = mock(FormulaParameterConbination.class);
        when(parameterConbination2.getParametersMinimumNumber()).thenReturn(1);
        when(parameterConbination2.getParametersMaximumNumber()).thenReturn(1);
        SortedSet<FormulaParameterConbinationItem> parameterConbinationItems2 = new TreeSet<>(Comparator.comparing(
                FormulaParameterConbinationItem::getId));
        FormulaParameterConbinationItem parameterConbinationItem2 = mock(FormulaParameterConbinationItem.class);
        when(parameterConbinationItem2.getId()).thenReturn(1);
        when(parameterConbinationItem2.isValidType(parameters.get(0), null)).thenReturn(false);
        parameterConbinationItems2.add(parameterConbinationItem2);
        when(parameterConbination2.getParameters()).thenReturn(parameterConbinationItems2);
        when(usage2.getParameterConbination()).thenReturn(parameterConbination2);
        usages.add(usage2);
        when(description.getUsages()).thenReturn(usages);
        List<FormulaUsage> minimalParameterNumberUsages = new ArrayList<>();
