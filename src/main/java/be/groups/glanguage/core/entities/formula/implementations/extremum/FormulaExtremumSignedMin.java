...
/**
 * Formula implementing a mathematical min operation on absolute values of a list of number
 *
 * @author michotte
 */
@Entity
...
public class FormulaExtremumSignedMin extends ExtremumFormula {
    ...
    public FormulaExtremumSignedMin(FormulaDescription description,
    ...
    /**
     * Get the smallest absolute value of the parameters as {@link Double} signed with the sign of the first parameter
     *
     * @param evaluator the evaluator to be used in the evaluation process, can be null
     * @return the smallest absolute value of the parameters as {@link Double} signed with the sign of the first
     * parameter
