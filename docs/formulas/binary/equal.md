...
__ATTENTION__ :
Le test d'égalité ne peux se faire qu'entre certains type de données. Ce référer aux "usages" et à la syntaxe pour savoir ce quels types sont compatibles à la comparaison.
