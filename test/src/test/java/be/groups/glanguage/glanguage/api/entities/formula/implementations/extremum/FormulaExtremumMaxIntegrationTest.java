 ...
 * @author DUPIREFR
 */
public class FormulaExtremumMaxIntegrationTest extends BaseDatabaseTest {
	...
	public void testIsValidMatchingIntegers() throws GLanguageException {
		...
		doReturn(FormulaDescriptionFactory.getDescription(FormulaType.F_MAX)).when(formula).getDescription();
